...
export let ANNOUNCEMENTS: any[] = [
  {
    ...
    authorId: 1, isPublished: 1, publishedAt: past(5), createdAt: past(6), updatedAt: past(5),
  },
  {
    id: 2,
    title: "시스템 점검 예정 공지",
    content: "<p>2024년 2월 28일 새벽 2시~4시 시스템 점검이 예정되어 있습니다.</p>",
    authorId: 1, isPublished: 1, publishedAt: past(2), createdAt: past(3), updatedAt: past(2),
  },
  {
    id: 3,
    title: "[초안] 신규 기능 출시 예정",
    content: "<p>곧 새로운 기능이 출시될 예정입니다.</p>",
    authorId: 1, isPublished: 0, publishedAt: null, createdAt: past(1), updatedAt: past(1),
  },
];
...
export let IMAGES: any[] = [
  {
    ...
    mimeType: "image/jpeg", fileSize: 204800, uploadedBy: 1,
    isPublished: 1, displayOrder: 1, createdAt: past(10), updatedAt: past(10),
  },
  {
    id: 2, title: "갤러리 이미지 1", description: null,
    fileKey: "mock/gallery1.jpg", url: "https://picsum.photos/seed/gallery1/800/600",
    mimeType: "image/jpeg", fileSize: 102400, uploadedBy: 1,
    isPublished: 1, displayOrder: 2, createdAt: past(7), updatedAt: past(7),
  },
  {
    id: 3, title: "[비공개] 갤러리 이미지 2", description: null,
    fileKey: "mock/gallery2.jpg", url: "https://picsum.photos/seed/gallery2/800/600",
    mimeType: "image/jpeg", fileSize: 98304, uploadedBy: 1,
    isPublished: 0, displayOrder: 3, createdAt: past(3), updatedAt: past(3),
  },
];
...
export let FLOATING_MESSAGES: any[] = [
  {
    ...
    messageType: "announcement", isActive: 1,
  ...
  },
  {
    ...
    messageType: "warning", isActive: 0,
...
export const getEnabledFeatures = (churchId: number): string[] =>
  FEATURES.filter((f) => f.churchId === churchId && f.isEnabled).map((f) => f.featureKey);
